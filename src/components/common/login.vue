...
export default {
    ...
    methods: {
        ...
        login() {
            console.log("登录操作执行-------");
            this.$axios({
                url: 'http://localhost:8081/dgut/user/login',
                method: 'post',
                data: {
                    ...this.formLabelAlign
                }
    ...
    <div id="login">
        ...
        <el-row class="main-container">
            <el-col :lg="8" :xs="16" :md="10" :span="10">
                <div class="top">
                    <i class="iconfont icon-kaoshi"></i><span class="title">云边际系统</span>
                </div>
                <div class="bottom">
                    <div class="container">
        ...
        <el-row class="footer">
            <el-col>
                <p class="msg2">版权所有 ©2022 东莞理工学院工软1班小邢 保留所有权利 </p>
            </el-col>
        </el-row>
        <section class="remind">
            <span>管理员账号：123456</span>
            <span>教师账号：20201001</span>
